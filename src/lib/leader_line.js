...
// We include the file by ourselves and don't use the npm package,
// to add `export default LeaderLine` at the end of the file
// https://github.com/anseki/leader-line/issues/74
...
var LeaderLine = (function () {
  ...
  var Z,
    ...
    F = { behind: Y, disc: "disc", square: "square", arrow1: "arrow1", arrow2: "arrow2", arrow3: "arrow3", hand: "hand", crosshair: "crosshair" },
    q = { disc: "disc", square: "square", arrow1: "arrow1", arrow2: "arrow2", arrow3: "arrow3", hand: "hand", crosshair: "crosshair" },
    G = [b, k, L, A],
    D = "auto",
    ...
    g =
      ((_ = { ease: [0.25, 0.1, 0.25, 1], linear: [0, 0, 1, 1], "ease-in": [0.42, 0, 1, 1], "ease-out": [0, 0, 0.58, 1], "ease-in-out": [0.42, 0, 0.58, 1] }),
      (v = 1e3 / 60 / 2),
      (l =
        ...
        stop: function (t, n) {
          ...
          return (
            E.some(function (e) {
              return (
                e.animId === t &&
                (n ? null != e.lastFrame && (a = e.frames[e.lastFrame].timeRatio) : ((a = (Date.now() - e.framesStart) / e.duration), (a = e.reverse ? 1 - a : a) < 0 ? (a = 0) : 1 < a && (a = 1)),
                !(e.framesStart = null))
              )
            }),
            a
          ...
          i.prototype = {
            parseSegment: function () {
              ...
              if (null === t) {
                ...
                if (
                  null ===
                  (t = ("+" === e || "-" === e || "." === e || ("0" <= e && e <= "9")) && "Z" !== this._prevCommand ? ("M" === this._prevCommand ? "L" : "m" === this._prevCommand ? "l" : this._prevCommand) : null)
                )
                  return null
            ...
            _skipOptionalSpacesOrDelimiter: function () {
              return (
                ...
                (this._skipOptionalSpaces() && this._currentIndex < this._endIndex && "," === this._string[this._currentIndex] && ((this._currentIndex += 1), this._skipOptionalSpaces()),
                ...
                "M" === e.type
                  ...
                  : "C" === e.type
                    ? ((o = e.values[0]),
                      ...
                      (f = s))
                    : "L" === e.type
                      ? ((r = e.values[0]), (s = e.values[1]), u.push({ type: "L", values: [r, s] }), (d = r), (f = s))
                      : "H" === e.type
                        ...
                        : "V" === e.type
                          ...
                          : "S" === e.type
                            ...
                            : "T" === e.type
                              ? ((r = e.values[0]),
                                (s = e.values[1]),
                                (l = "Q" === h || "T" === h ? ((o = d + (d - p)), f + (f - c)) : ((o = d), f)),
                                u.push({ type: "C", values: [(a = d + (2 * (o - d)) / 3), (i = f + (2 * (l - f)) / 3), r + (2 * (o - r)) / 3, s + (2 * (l - s)) / 3, r, s] }),
                                (p = o),
                                (c = l),
                                (d = r),
                                (f = s))
          ...
          var s = e.SVGPathElement.prototype.setAttribute,
            ...
            b = function (e, t, n, a, i, o, l, r, s, u) {
              ...
              u
                ...
                : ((e = (m = h(e, t, -p)).x),
                  (t = m.y),
                  1 < (m = ((y = (e - (n = (f = h(n, a, -p)).x)) / 2) * y) / (i * i) + ((d = (t - (a = f.y)) / 2) * d) / (o * o)) && ((i *= m = Math.sqrt(m)), (o *= m)),
                  (f = i * i),
                  (m = o * o),
                  (S = ((f = (r === s ? -1 : 1) * Math.sqrt(Math.abs((f * m - f * d * d - m * y * y) / (f * d * d + m * y * y)))) * i * d) / o + (e + n) / 2),
                  (g = (f * -o * y) / i + (t + a) / 2),
              ...
              Math.abs(m) > (120 * Math.PI) / 180 &&
                ...
                (f = n),
                (y = a),
                (v = s && _ < v ? _ + ((120 * Math.PI) / 180) * 1 : _ + ((120 * Math.PI) / 180) * -1),
                (n = S + i * Math.cos(v)),
                (a = g + o * Math.sin(v)),
    ...
    S =
      ...
      (Ee.t = function (t, e) {
        ...
        if ((Ee.r(n), Object.defineProperty(n, "default", { enumerable: !0, value: t }), 2 & e && "string" != typeof t))
          for (var a in t)
            Ee.d(
              n,
              a,
  ...
  function ke(t, n) {
    ...
    return (
      typeof t != typeof n ||
      (e = he(t) ? "obj" : Array.isArray(t) ? "array" : "") != (he(n) ? "obj" : Array.isArray(n) ? "array" : "") ||
      ("obj" === e
  ...
  function Ne(e, t, n, a, i) {
    ...
    return { x: h, y: p, fromP2: { x: c, y: u }, toP1: { x: s, y: l }, fromP1: { x: o, y: e }, toP2: { x: t, y: i }, angle: (a += 180 < a ? -180 : 180) }
  }
  function Te(n, a, i, o, e) {
    ...
    var r,
      s,
      u = [0.2491, 0.2491, 0.2335, 0.2335, 0.2032, 0.2032, 0.1601, 0.1601, 0.1069, 0.1069, 0.0472, 0.0472],
      h = 0,
  ...
  function We(e, t, n, a, i) {
    for (var o, l = 0.5, r = 1 - l; (o = Te(e, t, n, a, r)), !(Math.abs(o - i) <= 0.01); ) r += (o < i ? 1 : -1) * (l /= 2)
    return r
  }
  function Be(e, t) {
    var n
    return (
      e.forEach(function (e) {
        ...
        ;(n = n || [{ type: "M", values: [e[0].x, e[0].y] }]).push(
          e.length ? (2 === e.length ? { type: "L", values: [e[1].x, e[1].y] } : { type: "C", values: [e[1].x, e[1].y, e[2].x, e[2].y, e[3].x, e[3].y] }) : { type: "Z", values: [] },
        )
      }),
      n
    )
  ...
  function qe(e) {
    ...
    return (
      "static" !== e.position
        ? ((n.x -= [a.marginLeft, a.borderLeftWidth, a.paddingLeft, e.marginLeft, e.borderLeftWidth].reduce(t, 0)), (n.y -= [a.marginTop, a.borderTopWidth, a.paddingTop, e.marginTop, e.borderTopWidth].reduce(t, 0)))
        : "static" !== a.position && ((n.x -= [a.marginLeft, a.borderLeftWidth].reduce(t, 0)), (n.y -= [a.marginTop, a.borderTopWidth].reduce(t, 0))),
      n
    )
  }
  function Qe(e) {
            ...
            p.socketSE[e] ||
              (c[e].width || c[e].height
                ? c[e].width || (v[e].socketId !== A && v[e].socketId !== k)
                  ? c[e].height || (v[e].socketId !== b && v[e].socketId !== L) || (v[e].socketId = 0 <= v[e ? 0 : 1].y - c[e].top ? L : b)
                  : (v[e].socketId = 0 <= v[e ? 0 : 1].x - c[e].left ? k : A)
                : ((t = v[e ? 0 : 1].x - c[e].left), (n = v[e ? 0 : 1].y - c[e].top), (v[e].socketId = Math.abs(t) >= Math.abs(n) ? (0 <= t ? k : A) : 0 <= n ? L : b)))
          })),
      f.position_path !== y.position_path ||
        ...
        [0, 1].some(function (e) {
          return (
            ...
            ((t = v[e]), (n = y.position_socketXYSE[e]), t.x !== n.x || t.y !== n.y || t.socketId !== n.socketId) ||
            ((t = g[e]),
            (n = y.position_socketGravitySE[e]),
            (e = null == t ? "auto" : Array.isArray(t) ? "array" : "number") != (null == n ? "auto" : Array.isArray(n) ? "array" : "number") || ("array" == e ? t[0] !== n[0] || t[1] !== n[1] : t !== n))
          )
          var t, n
        }))
    ) {
                    ...
                    ? e.socketId === b
                      ...
                      : e.socketId === k
                        ...
                        : e.socketId === L
                          ...
                          : { x: -a, y: 0 }
                    : ((n = v[t ? 0 : 1]),
                      (a = 0 < (a = f.position_plugOverheadSE[t]) ? U + (K < a ? (a - K) * J : 0) : z + (f.position_lineStrokeWidth > j ? (f.position_lineStrokeWidth - j) * H : 0)),
                      e.socketId === b
              ...
              (function () {
                ...
                if (o[0] === o[1]) {
                  if (n[0] && n[1])
                    return void (
                      ...
                      (u[0][o[0]] === u[1][o[1]]
                        ...
                        : ((e = u[0][o[0]] + (u[1][o[1]] - u[0][o[0]]) / 2), s[0].push(c(u[0], Math.abs(e - u[0][o[0]]))), s[1].push(c(u[1], Math.abs(e - u[1][o[1]])))))
                    )
                  n[0] !== n[1]
                    ? ((t = y(n)),
                      (a = m(u[t.notContain], u[t.contain], o[t.notContain])) < ee && (u[t.notContain] = c(u[t.notContain], ee - a)),
                      s[t.notContain].push(u[t.notContain]),
                      (u[t.notContain] = c(u[t.notContain], ee, f(u[t.contain], u[t.notContain]) ? ("x" === o[t.notContain] ? r : l) : S(u[t.notContain], u[t.contain], "x" === o[t.notContain] ? "y" : "x"))))
                  ...
                  n[0] !== n[1]
                    ? ((t = y(n)),
                      s[t.notContain].push(u[t.notContain]),
                      (u[t.notContain] = c(u[t.notContain], ee, m(u[t.notContain], u[t.contain], o[t.contain]) >= ee ? S(u[t.notContain], u[t.contain], o[t.contain]) : u[t.contain].dirId)))
                    : ((i = [
                        { x: u[0].x, y: u[0].y },
                        { x: u[1].x, y: u[1].y },
                      ]),
        ...
        f.position_plugOverheadSE.forEach(function (e, t) {
          ...
          0 < e
            ? 2 === (n = _[(a = p ? 0 : _.length - 1)]).length
              ? ((d[a] = d[a] || Ae.apply(null, n)), d[a] > $ && (d[a] - e < $ && (e = d[a] - $), (s = Ve(n[0], n[1], (p ? e : d[a] - e) / d[a])), (_[a] = p ? [s, n[1]] : [n[0], s]), (d[a] -= e)))
    ...
    t.line &&
        ...
        (U.plug =
          ...
          [0, 1].forEach(function (e) {
            ...
            ;(f = Xe(h, c.plug_enabledSE, e, u !== Y) || f),
              ...
              c.plug_enabledSE[e]
                ? ((s = (c.line_strokeWidth / ue.lineSize) * p.plugSizeSE[e]), (c.position_plugOverheadSE[e] = t.overhead * s), (c.viewBox_plugBCircleSE[e] = t.bCircle * s), (l = t.sideLen * s), (r = t.backLen * s))
      ...
      (t.lineOutline || U.line) &&
        (U.lineOutline =
          ...
          (k = Xe(i, l, "lineOutline_inStrokeWidth", l.lineOutline_colorTra ? l.lineOutline_strokeWidth + 2 * se : l.line_strokeWidth - o) || k))),
      ...
      (t.faces || U.line || U.plug || U.lineOutline || U.plugOutline) &&
        (U.faces =
          ...
          (v = m.events),
          (E = !1),
          !g.line_altColor && Xe(m, _, "line_color", (S = g.line_color), v.apl_line_color) && ((m.lineFace.style.stroke = S), (E = !0)),
          Xe(m, _, "line_strokeWidth", (S = g.line_strokeWidth), v.apl_line_strokeWidth) &&
            ((m.lineShape.style.strokeWidth = S + "px"), (E = !0), (oe || ie) && (je(m, m.lineShape), ie && (je(m, m.lineFace), je(m, m.lineMaskCaps)))),
          Xe(m, _, "lineOutline_enabled", (S = g.lineOutline_enabled), v.apl_lineOutline_enabled) && ((m.lineOutlineFace.style.display = S ? "inline" : "none"), (E = !0)),
          g.lineOutline_enabled &&
            (Xe(m, _, "lineOutline_color", (S = g.lineOutline_color), v.apl_lineOutline_color) && ((m.lineOutlineFace.style.stroke = S), (E = !0)),
            Xe(m, _, "lineOutline_strokeWidth", (S = g.lineOutline_strokeWidth), v.apl_lineOutline_strokeWidth) &&
              ((m.lineOutlineMaskShape.style.strokeWidth = S + "px"), (E = !0), ie && (je(m, m.lineOutlineMaskCaps), je(m, m.lineOutlineFace))),
            Xe(m, _, "lineOutline_inStrokeWidth", (S = g.lineOutline_inStrokeWidth), v.apl_lineOutline_inStrokeWidth) &&
              ((m.lineMaskShape.style.strokeWidth = S + "px"), (E = !0), ie && (je(m, m.lineOutlineMaskCaps), je(m, m.lineOutlineFace)))),
          Xe(m, _, "plug_enabled", (S = g.plug_enabled), v.apl_plug_enabled) && ((m.plugsFace.style.display = S ? "inline" : "none"), (E = !0)),
          g.plug_enabled &&
              ...
              Xe(m, _.plug_enabledSE, n, (S = g.plug_enabledSE[n]), v.apl_plug_enabledSE) && ((m.plugsFace.style[a.prop] = S ? "url(#" + m.plugMarkerIdSE[n] + ")" : "none"), (E = !0)),
                g.plug_enabledSE[n] &&
                  ...
                  Xe(m, _.plug_colorSE, n, (S = g.plug_colorSE[n]), v.apl_plug_colorSE) &&
                    ((m.plugFaceSE[n].style.fill = S), (E = !0), (le || re || ie) && !g.line_colorTra && je(m, ie ? m.lineMaskCaps : m.capsMaskLine)),
                  ["markerWidth", "markerHeight"].forEach(function (e) {
                    var t = "plug_" + e + "SE"
                    Xe(m, _[t], n, (S = g[t][n]), v["apl_" + t]) && ((m.plugMarkerSE[n][e].baseVal.value = S), (E = !0))
                  }),
                  Xe(m, _.plugOutline_enabledSE, n, (S = g.plugOutline_enabledSE[n]), v.apl_plugOutline_enabledSE) &&
                    (S
                      ? ((m.plugFaceSE[n].style.mask = "url(#" + m.plugMaskIdSE[n] + ")"), (m.plugOutlineFaceSE[n].style.display = "inline"))
                      : ((m.plugFaceSE[n].style.mask = "none"), (m.plugOutlineFaceSE[n].style.display = "none")),
                    (E = !0)),
      ...
      (U.viewBox =
        ...
        (P = O.svg.style),
        (N = !1),
        (I = Math.max(M.line_strokeWidth / 2, M.viewBox_plugBCircleSE[0] || 0, M.viewBox_plugBCircleSE[1] || 0)),
      ...
      (U.mask =
        ...
        (R.caps_enabled = R.capsMaskMarker_enabled || R.capsMaskAnchor_enabledSE[0] || R.capsMaskAnchor_enabledSE[1]),
        ...
        Xe(W, F, "lineMask_enabled", (B = R.lineMask_enabled)) && ((W.lineFace.style.mask = B ? "url(#" + W.lineMaskId + ")" : "none"), (G = !0), re && je(W, W.lineMask)),
        R.lineMask_enabled &&
          (Xe(W, F, "lineMask_outlineMode", (B = R.lineMask_outlineMode)) &&
            (B ? ((W.lineMaskBG.style.display = "none"), (W.lineMaskShape.style.display = "inline")) : ((W.lineMaskBG.style.display = "inline"), (W.lineMaskShape.style.display = "none")), (G = !0)),
          ["x", "y"].forEach(function (e) {
            var t = "lineMask_" + e
            Xe(W, F, t, (B = R[t])) && ((W.lineMask[e].baseVal.value = B), (G = !0))
          }),
          Xe(W, F, "caps_enabled", (B = R.caps_enabled)) && ((W.lineMaskCaps.style.display = W.lineOutlineMaskCaps.style.display = B ? "inline" : "none"), (G = !0), re && je(W, W.capsMaskLine)),
          R.caps_enabled &&
            ([0, 1].forEach(function (e) {
              var t
                ...
                Xe(W, F.capsMaskMarker_enabledSE, n, (B = R.capsMaskMarker_enabledSE[n])) && ((W.capsMaskLine.style[a.prop] = B ? "url(#" + W.lineMaskMarkerIdSE[n] + ")" : "none"), (G = !0)),
                  R.capsMaskMarker_enabledSE[n] &&
                    (Xe(W, F.capsMaskMarker_plugSE, n, e) &&
                      ...
                      Ue(W, W.capsMaskMarkerSE[n], a.orient, t.bBox, W.svg, W.capsMaskMarkerShapeSE[n], W.capsMaskLine),
                      (G = !0),
  ...
  function it(s, u) {
    ...
    function v(e, t, n, a, i, o, l) {
      var r,
        ...
        l = _(e, n, i, o, l)
      return (
        null != t[n] && (s = (t[n] + "").toLowerCase()) && ((l.acceptsAuto && s === D) || (u = a[s])) && u !== l.container[l.key] && ((l.container[l.key] = u), (r = !0)),
    ...
    function E(e, t, n, a, i, o, l, r, s) {
      ...
      return (
        null != t[n] &&
          ((l.acceptsAuto && (t[n] + "").toLowerCase() === D) || ((p = h = t[n]), ("number" === (c = a) ? pe(p) : typeof p === c) && ((h = s && "string" === a && h ? h.trim() : h), 1) && (!r || r(h)))) &&
          h !== l.container[l.key] &&
    ...
    i &&
      ...
      })(!1 !== s.optionIsAttach.anchorSE[0] ? _e[S.anchorSE[0]._id].element : S.anchorSE[0], !1 !== s.optionIsAttach.anchorSE[1] ? _e[S.anchorSE[1]._id].element : S.anchorSE[1])) !== s.baseWindow &&
      ((e = c),
      (f = (n = s).aplStats),
      (y = e.document),
      (m = C + "-" + n._id),
      ...
      (l.href.baseVal = "#" + h),
      (l.style.display = "none"),
      n.curStats.show_inAnim ? ((n.isShown = 1), w[f.show_effect].stop(n, !0)) : n.isShown || (t.style.visibility = "hidden"),
          ...
          (Array.isArray(e)
            ? pe(e[0]) &&
              ...
              Array.isArray(S.socketGravitySE[t]) &&
                ...
                (i = !1))
            : ((e + "").toLowerCase() === D ? (i = null) : pe(e) && 0 <= e && (i = e), i === S.socketGravitySE[t] && (i = !1)),
        ...
        function r(e) {
          ...
          return (
            e.hasOwnProperty("animation")
              ...
              : ((t = !!o.defaultEnabled), (s.curStats[n] = t ? et({}, o.defaultAnimOptions) : null)),
            t
          )
        }
        u.hasOwnProperty(a) &&
      ...
      dash: {
        ...
        update: function (t) {
          ...
          ;(n.dash_len = i.len || 2 * a.line_strokeWidth),
            ...
            (o = Xe(t, a, "dash_gap", n.dash_gap) || o) && (t.lineFace.style.strokeDasharray = a.dash_len + "," + a.dash_gap),
            n.dash_animOptions
              ? ((o = Xe(t, a, "dash_maxOffset", n.dash_maxOffset)),
                a.dash_animOptions && (o || ke(n.dash_animOptions, a.dash_animOptions)) && (n.dash_animId && ((e = g.stop(n.dash_animId)), g.remove(n.dash_animId)), (a.dash_animOptions = null)),
                a.dash_animOptions ||
                  ((n.dash_animId = g.add(
                    function (e) {
      ...
      dropShadow: {
        ...
        init: function (t) {
          var e,
            ...
            s =
              ...
              (o.id = n),
              u
                ? ((i.elmOffset = i.elmBlur = a = o.appendChild(e.createElementNS(ae, "feDropShadow"))), (i.styleFlood = a.style))
                : ((i.elmBlur = o.appendChild(e.createElementNS(ae, "feGaussianBlur"))),
                  ...
                  ((a = o.appendChild(e.createElementNS(ae, "feComposite"))).in2.baseVal = "offsetblur"),
        ...
        update: function (e) {
          ...
          ;(a.dropShadow_dx = t = o.dx),
            ...
            Xe(e, i, "dropShadow_blur", t) && (e.efc_dropShadow_elmBlur.setStdDeviation(t, t), (n = !0)),
            n && $e(e, {}),
        ...
        adjustEdge: function (a, i) {
          ...
          null != o.dropShadow_dx &&
            ...
            (e = { x1: i.x1 - e + o.dropShadow_dx, y1: i.y1 - e + o.dropShadow_dy, x2: i.x2 + e + o.dropShadow_dx, y2: i.y2 + e + o.dropShadow_dy }).x1 < i.x1 && (i.x1 = e.x1),
            e.y1 < i.y1 && (i.y1 = e.y1),
            e.x2 > i.x2 && (i.x2 = e.x2),
            e.y2 > i.y2 && (i.y2 = e.y2),
            ["x", "y"].forEach(function (e) {
      ...
      draw: {
        ...
        stop: function (e, t, n) {
          ...
          return (
            ...
            (i.show_inAnim = !1),
            t && ((e.pathList.animVal = n ? null : [[e.pathList.baseVal[0][0], e.pathList.baseVal[0][0]]]), $e(e, { path: !0 }), Je(e, n)),
            a
          )
        },
        update: function (e) {
    ...
    (O = {
      ...
      areaAnchor: {
        ...
        init: function (a, e) {
          ...
          return (
            ...
            e.dash && ((a.dash = !0), pe(e.dash.len) && 0 < e.dash.len && (a.dashLen = e.dash.len), pe(e.dash.gap) && 0 < e.dash.gap && (a.dashGap = e.dash.gap)),
            "circle" === e.shape
              ? (a.shape = e.shape)
              : "polygon" === e.shape &&
        ...
        update: function (t) {
          var n,
            ...
            v = {}
          if (
            ((v.strokeWidth = Xe(t, S, "strokeWidth", null != t.size ? t.size : _ ? _.line_strokeWidth : ue.lineSize)),
            (n = Ie(t.element)),
                ...
                ;((c = { left: t.x[0] * (t.x[1] ? n.width : 1), top: t.y[0] * (t.y[1] ? n.height : 1), width: t.width[0] * (t.width[1] ? n.width : 1), height: t.height[0] * (t.height[1] ? n.height : 1) }).right =
                  ...
                  (h = (r = t.radius ? (t.radius <= s ? t.radius : s) : 0)
                    ? ((s = (r - p) / Math.SQRT2),
                      ...
                      (S.pathListRel = [[h[0], { x: h[0].x, y: h[0].y - (p = r * te) }, { x: h[1].x - p, y: h[1].y }, h[1]]]),
                      h[1].x !== h[2].x && S.pathListRel.push([h[1], h[2]]),
                      S.pathListRel.push([h[2], { x: h[2].x + p, y: h[2].y }, { x: h[3].x, y: h[3].y - p }, h[3]]),
                      h[3].y !== h[4].y && S.pathListRel.push([h[3], h[4]]),
                      S.pathListRel.push([h[4], { x: h[4].x, y: h[4].y + p }, { x: h[5].x + p, y: h[5].y }, h[5]]),
                      h[5].x !== h[6].x && S.pathListRel.push([h[5], h[6]]),
                      S.pathListRel.push([h[6], { x: h[6].x - p, y: h[6].y }, { x: h[7].x, y: h[7].y + p }, h[7]]),
                    ...
                    : ((u = S.strokeWidth / 2),
                      ...
                      (S.pathListRel = [[h[0], { x: h[1].x, y: h[0].y }], [{ x: h[1].x, y: h[0].y }, h[1]], [h[1], { x: h[0].x, y: h[1].y }], []]),
                      [
          ...
          return (
            ...
            t.dash &&
              ((!v.pathData && (!v.strokeWidth || (t.dashLen && t.dashGap))) || ((S.dashLen = t.dashLen || 2 * S.strokeWidth), (S.dashGap = t.dashGap || S.strokeWidth)),
      ...
      mouseHoverAnchor: {
        ...
        init: function (a, i) {
          var n,
            ...
            c = {}
          if (((a.element = O.pointAnchor.checkElement(i.element)), (s = a.element), !((u = s.ownerDocument) && (h = u.defaultView) && h.HTMLElement && s instanceof h.HTMLElement)))
            throw new Error("`element` must be HTML element")
          return (
            (p.style.backgroundSize = p.backgroundSize.width + "px " + p.backgroundSize.height + "px"),
            ...
            a.style.display && ((e = a.element.style.display), (a.element.style.display = a.style.display)),
            O.mouseHoverAnchor.dirKeys.forEach(function (e) {
              e = "padding" + e[1]
              ...
              (ie
                ? ((h = p.minHeight),
                  "content-box" === n.boxSizing
                    ? (h -= parseFloat(n.borderTopWidth) + parseFloat(n.borderBottomWidth) + parseFloat(n.paddingTop) + parseFloat(n.paddingBottom))
                    : "padding-box" === n.boxSizing && (h -= parseFloat(n.borderTopWidth) + parseFloat(n.borderBottomWidth)),
                  (a.style.height = h + "px"))
                : (a.style.height = parseFloat(n.height) + (p.minHeight - s.height) + "px")),
            (a.style.backgroundPosition = re
              ? s.width - p.backgroundSize.width - p.backgroundPosition.right + "px " + p.backgroundPosition.top + "px"
              : "right " + p.backgroundPosition.right + "px top " + p.backgroundPosition.top + "px"),
      ...
      captionLabel: {
        ...
        init: function (l, t) {
          return (
            ...
            !!l.text &&
              ...
              Array.isArray(t.offset) && pe(t.offset[0]) && pe(t.offset[1]) && (l.offset = { x: t.offset[0], y: t.offset[1] }),
              ...
              (l.updateSocketXY = function (e) {
                ...
                null != o.x &&
                  (l.offset
                    ...
                    : ((t = l.height / 2),
                      (e = Math.max(i.attach_plugSideLenSE[l.socketIndex] || 0, i.line_strokeWidth / 2)),
                      (i = i.position_socketXYSE[l.socketIndex ? 0 : 1]),
                      o.socketId === A || o.socketId === k
                        ? ((n.x = o.socketId === A ? o.x - t - l.width : o.x + t), (n.y = i.y < o.y ? o.y + e + t : o.y - e - t - l.height))
                        : ((n.x = i.x < o.x ? o.x + e + t : o.x - e - t - l.width), (n.y = o.socketId === b ? o.y - t - l.height : o.y + t))),
                  Xe(l, a, "x", (t = n.x)) && (l.elmPosition.x.baseVal.getItem(0).value = t),
                  Xe(l, a, "y", (t = n.y)) && (l.elmPosition.y.baseVal.getItem(0).value = t + l.height))
              }),
              (l.updatePath = function (e) {
                ...
                e &&
                  ...
                  Xe(l, n, "y", (e = t.y)) && (l.elmPosition.y.baseVal.getItem(0).value = e + l.height))
              }),
              ...
              re &&
                (l.adjustEdge = function (e, t) {
                  var n = l.curStats
                  null != n.x && O.captionLabel.adjustEdge(t, { x: n.x, y: n.y, width: l.width, height: l.height }, l.strokeWidth / 2)
                }),
              !0)
          )
        },
          ...
          return (
            ...
            i && !h
              ? ((o = t.createElementNS(ae, "defs")),
                (r.id = a),
                o.appendChild(r),
                ((l = (e = t.createElementNS(ae, "g")).appendChild(t.createElementNS(ae, "use"))).href.baseVal = "#" + a),
                ((t = e.appendChild(t.createElementNS(ae, "use"))).href.baseVal = "#" + a),
                ((l = l.style).strokeLinejoin = "round"),
                { elmPosition: r, styleText: r.style, styleFill: t.style, styleStroke: l, styleShow: e.style, elmsAppend: [o, e] })
              : ((l = r.style), i && ((l.strokeLinejoin = "round"), (l.paintOrder = "stroke")), { elmPosition: r, styleText: l, styleFill: l, styleStroke: i ? l : null, styleShow: l, elmsAppend: [r] })
          )
        },
        ...
        initSvg: function (t, n) {
          ...
          ;["elmPosition", "styleFill", "styleShow", "elmsAppend"].forEach(function (e) {
            ...
            (t.width = e.width),
            (t.height = e.height),
            t.outlineColor && ((a = e.height / 9), (i.styleStroke.strokeWidth = (a = 10 < a ? 10 : a < 2 ? 2 : a) + "px"), (i.styleStroke.stroke = t.outlineColor)),
            (t.strokeWidth = a || 0),
          ...
          return (
            ...
            (e.refSocketXY = "startLabel" === t.optionName || "endLabel" === t.optionName)
              ? ((e.socketIndex = "startLabel" === t.optionName ? 0 : 1),
                ...
                e.offset || (Ge(n, "cur_attach_plugSideLenSE", e.updateSocketXY), Ge(n, "cur_line_strokeWidth", e.updateSocketXY)))
      ...
      pathLabel: {
          ...
          return (
            ...
            !!l.text &&
              ...
              (l.updatePath = function (e) {
                ...
                i &&
                  ((t.pathData = a = O.pathLabel.getOffsetPathData(i, a.line_strokeWidth / 2 + l.strokeWidth / 2 + l.height / 4, 1.25 * l.height)),
                  Fe(a, n.pathData) && (l.elmPath.setPathData(a), (n.pathData = a), (l.bBox = l.elmPosition.getBBox()), l.updateStartOffset(e)))
              }),
              (l.updateStartOffset = function (e) {
                ...
                n.pathData &&
                  ((2 === l.semIndex && !l.lineOffset) ||
                    ...
                    2 !== l.semIndex &&
                      ((o = Math.max(o.attach_plugBackLenSE[l.semIndex] || 0, o.line_strokeWidth / 2) + l.strokeWidth / 2 + l.height / 4), (e = (e += 0 === l.semIndex ? o : -o) < 0 ? 0 : t < e ? t : e)),
          ...
          return (
            e.forEach(function (e) {
              ...
              2 === e.length
                ? ((s = e[0]),
                  ...
                  d
                    ? ((a = d.points),
                      0 <= (r = Math.atan2(a[1].y - a[0].y, a[0].x - a[1].x) - Math.atan2(e[0].y - e[1].y, e[1].x - e[0].x)) && r <= Math.PI
                        ...
                        : ((o = Pe(a[0], a[1], c)),
                          ...
                          (n = (h = 0 <= s && s <= 1 && 0 <= u && u <= 1 ? { x: l.x + u * p, y: l.y + u * h } : null)
            ...
            f.forEach(function (e) {
              ...
              d =
                "line" === e.type
                  ? (e.inside &&
                      (d.len > c ? (((t = d.points)[1] = Pe(t[0], t[1], -c)), (d.len = Ae(t[0], t[1]))) : ((d.points = null), (d.len = 0)),
                      e.len > c + n ? (((t = e.points)[0] = Pe(t[1], t[0], -(c + n))), (e.len = Ae(t[0], t[1]))) : ((e.points = null), (e.len = 0))),
                    e)
                  : null
            }),
        ...
        newText: function (e, t, n, a) {
          ...
          return (
            (u.id = i = n + "-path"),
            ((l = (o = t.createElementNS(ae, "text")).appendChild(t.createElementNS(ae, "textPath"))).href.baseVal = "#" + i),
            ...
            a && !h
              ? ((o.id = e = n + "-text"),
                s.appendChild(o),
                ((r = (n = t.createElementNS(ae, "g")).appendChild(t.createElementNS(ae, "use"))).href.baseVal = "#" + e),
                ((t = n.appendChild(t.createElementNS(ae, "use"))).href.baseVal = "#" + e),
                ((r = r.style).strokeLinejoin = "round"),
                { elmPosition: o, elmPath: u, elmOffset: l, styleText: o.style, styleFill: t.style, styleStroke: r, styleShow: n.style, elmsAppend: [s, n] })
              : ((r = o.style),
                a && ((r.strokeLinejoin = "round"), (r.paintOrder = "stroke")),
                { elmPosition: o, elmPath: u, elmOffset: l, styleText: r, styleFill: r, styleStroke: a ? r : null, styleShow: r, elmsAppend: [s, o] })
          )
        },
        initSvg: function (t, n) {
          var e,
          ...
          ;["elmPosition", "elmPath", "elmOffset", "styleFill", "styleShow", "elmsAppend"].forEach(function (e) {
            ...
            2 !== t.semIndex || t.lineOffset || o.elmOffset.startOffset.baseVal.newValueSpecifiedUnits(SVGLength.SVG_LENGTHTYPE_PERCENTAGE, 50),
            (t.height = e.height),
            t.outlineColor && ((a = e.height / 9), (o.styleStroke.strokeWidth = (a = 10 < a ? 10 : a < 2 ? 2 : a) + "px"), (o.styleStroke.stroke = t.outlineColor)),
            (t.strokeWidth = a || 0),
        ...
        bind: function (e, t) {
          ...
          return (
            ...
            (2 === e.semIndex && !e.lineOffset) || Ge(n, "cur_attach_plugBackLenSE", e.updateStartOffset),
            Ge(n, "svgShow", e.updateShow),
            re && Ge(n, "new_edge4viewBox", e.adjustEdge),
