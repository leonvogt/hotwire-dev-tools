<script>
  ...
  import ValueTree from "$components/Stimulus/ValueTree.svelte"
  import TargetTree from "$components/Stimulus/TargetTree.svelte"
  import OutletTree from "$components/Stimulus/OutletTree.svelte"
  import ClassTree from "$components/Stimulus/ClassTree.svelte"
