import { ALPINE_DEVTOOLS_PROXY_SOURCE } from "../browser_panel/ports"
import { BACKEND_TO_PANEL_MESSAGES, DEVTOOLS_RENDER_ATTR_NAME, DEVTOOLS_RENDER_BINDING_ATTR_NAME, PANEL_TO_BACKEND_MESSAGES } from "../lib/constants"
import { getComponentName, isSerializable, serializeHTMLElement, set, waitForAlpine, isRequiredVersion } from "../lib/utils"
  ...
  function handleMessages(e) {
    ...
    switch (e.data.payload.action) {
      ...
      case PANEL_TO_BACKEND_MESSAGES.EDIT_ATTRIBUTE: {
        devtoolsBackend.handleSetComponentData(e.data.payload.componentId, e.data.payload.attributeSequence, e.data.payload.attributeValue)
        break
      }
